...
export default function CorrespondenciaRecibida() {
    ...
    const fetcher = () => clienteAxios('/api/correspondences/received', {
        headers: {
                    ...
                    <tbody>
                        {
                            filteredItems.map(correspondencia => (
                                <tr className="bg-white border-b" key={correspondencia.id}>
                                    ...
                                    <td className={`p-2 font-bold border border-black ${correspondencia.receptor ? 'bg-green-500' : 'bg-red-500'}`}>
                                    ...
                                    <td className="p-2">
                                        ...
                                        <button className="bg-yellow-500 hover:bg-yellow-700 w-8 h-8 rounded-full mx-1"
                                            onClick={() => {
                                        ...
                                        {/* <button className="bg-green-500 hover:bg-green-700 w-8 h-8 rounded-full" onClick={() => {
                                            navigate(`/administrativo/correspondencia-recibida/${correspondencia.id}/colaboradores`)
                                        }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-white mx-auto">
